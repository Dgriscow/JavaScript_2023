...
let zackchug = {name:"Zack Chug", siteType: "Instagram",primaryRecipeType:"High Protein General", rating:10, ssLink:"images/zackchug.png", description:"This guy makes some of the most delishious looking foods, and they are all good for protein and bulking. The foods are all amazing looking, and jo has tried one before, and can also say for sure the recipies are great.", link:"https://www.instagram.com/tastyshreds/"}
let joshElkin = {name:"Josh Elkin", siteType: "Instagram",primaryRecipeType:"BreakFast", rating:8, ssLink:"images/joshElkin.png", description:"This account displays some absolutely delishious and unique recipies. Definetly a high priority for getting some unique meals. He specializes in making amazing breakfast foods, but every recipe he makes is amazing.", link:"https://www.instagram.com/thejoshelkin/"}


var Recipiez = [allRecipes, bonappetit, simplyRecipes, delish, helloFresh, panaceaPalm, tastyshreds, zackchug, joshElkin];
